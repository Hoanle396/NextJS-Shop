...
import { useProductById } from "../../app/apis/products";
...
function Product() {
  ...
  const { data } = useProductById(String(query?.slug));
        ...
        <div className="max-w-4xl mx-auto min-h-screen pt-16">
            ...
            <div className="photo md:w-1/3">
              <div>
                <img
                  ...
                  src={data.images[imgSelected].url}
                  alt=""
                />
              </div>
                ...
                <button
                  onClick={() => {
                    dispatch(
                      addToBasket({
                        ...data,
                        selectedSizeProp: data.sizes[selectedSize],
                      })
                    );
                  }}
          ...
          {/* <div className="text-cusblack p-2 md:px-10 md:py-6 mt-14 bg-white md:rounded-2xl shadow-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-x-4 gap-y-6">
              {dataAlso
                .filter((it, idx) => it.name != data.name)
                .map((data, idx) => {
                  if (idx < 4)
